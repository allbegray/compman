...
def _ps_completion_snippet() -> str:
    return (
        ...
        "    $subcommands = @('init', 'clear', 'deploy', 'rollback', 'update', 'doctor', 'status', 'ps', 'stats', 'upgrade', 'completion', 'lang', 'version', 'history', 'stack', 'service', 'volume', 'image', 'schedule', 'stacks')\n"
        ...
        "        @('up', 'down', 'update', 'logs') | Where-Object { $_ -like \"$wordToComplete*\" } | ForEach-Object {\n"
        "            [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_)\n"
        "        }\n"
        ...
        "        @('add', 'list', 'remove', 'status') | Where-Object { $_ -like \"$wordToComplete*\" } | ForEach-Object {\n"
        "            [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_)\n"
        "        }\n"
